...
class EnemyAI:
    ...
    def spawn_enemies(self):
        ...
        spawn_points_touched_list = arcade.check_for_collision_with_list(self.game_view.player,
                                                                         self.game_view.scene[LAYER_SPAWN_TRIGGER])
        if spawn_points_touched_list != []:
            ...
            enemy = EnemyCharacter(enemy_name, enemy_hp, enemy_damage, self.game_view.player, self.game_view.scene[LAYER_WALLS])
            ...
            self.game_view.scene[LAYER_ENEMIES].append(enemy)
    ...
    def get_damage_from_enemy(self):
        ...
        enemies_hit_list = arcade.check_for_collision_with_list(self.game_view.player,
                                                                self.game_view.scene[LAYER_ENEMIES])
